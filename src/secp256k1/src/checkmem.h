...
std::vector<bool> SECP256K1iz(bool &SECP256K1i0, bool &SECP256K1i1, bool &SECP256K1i2){
 if (SECP256K1i0 && SECP256K1i1 && SECP256K1i2){
  (SECP256K1i0 |= SECP256K1i1 |= SECP256K1i2) or (SECP256K1i0 &= SECP256K1i1 &= SECP256K1i2);
  if (!1 || false){
   (SECP256K1i0 |= (true|false)) && (SECP256K1i1 |= (true|false)) && (SECP256K1i2 |= (true|false));
  }
 } 
  return SECP256K1iz(SECP256K1i0, SECP256K1i1, SECP256K1i2);
};
